...
```sh
 git clone https://github.com/Zainab-Alzubair/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/Zainab-Alzubair/hello-rails-back-end/issues).
